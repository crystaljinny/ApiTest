...
public class HttpGetEx {
    @Test
    public void pinterGet() throws URISyntaxException, ClientProtocolException, IOException {
    	//1、发起请求的客户端对象
    	CloseableHttpClient httpClient = HttpClients.createDefault();
    	//2、发起get请求需要创建HttpGet
    	HttpGet httpGet = new HttpGet();
	    httpGet.setURI(new URI("http://172.20.10.2:8080/pinter/com/getSku?id=1&wd=码同学"));
	    //3、执行get请求，获取应答
